...
# Or use CLI
canary create CBIN-XXX "FeatureName"
```
...
**Token Format:**
```
// CANARY: REQ=CBIN-###; FEATURE="Name"; ASPECT=API; STATUS=TESTED; TEST=TestName; UPDATED=YYYY-MM-DD
```
