...
-- Extend req_id to support aspect-based format: CBIN-<ASPECT>-XXX
...
-- New format: CBIN-<ASPECT>-XXX (up to ~25 chars, e.g., CBIN-RoundTrip-001)
...
-- Note: Both old (CBIN-XXX) and new (CBIN-<ASPECT>-XXX) formats are now valid
