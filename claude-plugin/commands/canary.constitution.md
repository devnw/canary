...
2. **Read existing constitution** (if `.canary/memory/constitution.md` exists) to understand current principles

3. **Analyze user request** from the arguments:
...
4. **Create/update constitution** at `.canary/memory/constitution.md`:
...
5. **Validate constitution** against quality criteria:
