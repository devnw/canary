...
description: >
  ...
  have been added to the project and you need reproducible benchmark tests and
  evaluation reports.
  ...
  <example>
  Context: New subsystem implemented in the project
  user: "I finished the new transaction coordinator implementation."
  assistant: "Invoking canary-benchmarks to generate ACID/throughput/latency tests,
  micro/macro suites, and a reproducibility harness; will compare vs the prior coordinator."
  </example>

  <example>
  Context: Added new operators or parsing logic
  ...
  <example>
  Context: Updated a client pipeline or transport layer.
...
Use these commands for benchmark development:
...
SCENARIO = <e.g., OLTP, OLAP, streaming, batch>
...
### baseline-matrix
| Task | Baseline | Variant | Delta | 95% CI | Pass/Fail | Note |
