#!/usr/bin/env bash
# CANARY: REQ=REQ-SK-503; FEATURE="AgentContextUpdate"; ASPECT=Automation; STATUS=IMPL; TEST=test_agent_context_update_script_exists; OWNER=scripts; UPDATED=2025-10-15
