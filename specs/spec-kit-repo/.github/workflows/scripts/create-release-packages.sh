#!/usr/bin/env bash
# CANARY: REQ=REQ-SK-901; FEATURE="ReleasePackages"; ASPECT=PackageManagement; STATUS=IMPL; TEST=test_release_packages_script_exists; OWNER=release; UPDATED=2025-10-15
