---
description: Generate comprehensive implementation guidance for a CANARY requirement specification
---
...
Generate a complete implementation prompt that includes specification details, implementation plan, checklist, progress tracking, constitutional principles, test-first guidance, and CANARY token examples.
...
### Exact ID Match
```
/canary.implement <PROJECT_KEY>-<NNN>
```
...
```go
// CANARY: REQ=<PROJECT_KEY>-<NNN>; FEATURE="Name"; ASPECT=API; STATUS=IMPL; UPDATED=YYYY-MM-DD
...
```
User: /canary.implement <PROJECT_KEY>-105

Agent Response:
[Generates full implementation prompt with:
 - Spec for <PROJECT_KEY>-105
 - Plan details
 - Checklist
...
Agent: Found strong match (score: 92%): <PROJECT_KEY>-105 - UserAuthentication
...
1. <PROJECT_KEY>-105 - UserAuthentication (Score: 85%)
2. <PROJECT_KEY>-110 - OAuthIntegration (Score: 80%)
3. <PROJECT_KEY>-115 - AuthorizationRules (Score: 75%)

Select a requirement (1-3):
User: 1

[Generates prompt for <PROJECT_KEY>-105]
```
...
<PROJECT_KEY>-105 - UserAuthentication [25% complete]
  Total: 8 | Tested: 2 | Impl: 3 | Stub: 3

<PROJECT_KEY>-110 - OAuthIntegration [0% complete]
  Total: 5 | Tested: 0 | Impl: 0 | Stub: 5

<PROJECT_KEY>-112 - DataValidation [60% complete]
...
2. /canary.plan <PROJECT_KEY>-<NNN>
   -> Creates plan.md

3. /canary.implement <PROJECT_KEY>-<NNN>
...
3. Directory format: <PROJECT_KEY>-<NNN>-FeatureName
```
