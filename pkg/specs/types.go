...
// CANARY: REQ=CP-262; FEATURE="DependencyModel"; ASPECT=Storage; STATUS=TESTED; TEST=TestDependencyCreation,TestPartialFeatureDependency,TestPartialAspectDependency; UPDATED=2026-08-29
